...
class App extends Component {
  ...
  updateEval = () => {
    let teachAgainString = this.state.isTeachAgain === "Yes" ? " again" : "";

    const paragraph = `
        ${this.state.name}, it was an absolute pleasure teaching you${teachAgainString}. During open sessions, you ${this.state.openSessionMesage}. \n
    ...
    const updatedEval = paragraph
      ...
      .replace("${teachAgain}", this.state.isTeachAgain)
      .replace("${openSessionMessage}", this.state.openSessionMesage)
      .replace("${this.state.mhFeedback}", this.state.mhFeedback)
      .replace("${this.state.specificMHLesson}", this.state.specificMHLesson)
      .replace("${this.state.groupPresTopic}", this.state.groupPresTopic)
      .replace("${this.state.groupPresAppreciate}", this.state.groupPresAppreciate)
      .replace("${this.state.groupPresDescribe}", this.state.groupPresDescribe)
      .replace("${this.state.groupPresStatement}", this.state.groupPresStatement)
      .replace("${this.state.groupPresAgree}", this.state.groupPresAgree)
      .replace("${this.state.customSentence}", this.state.customSentence)
    ...
    return (
      <div>
        ...
        All in all, you did a wonderful job this semester of SOM. 
          <input
              type="text"
              placeholder='Write a personalized sentence here'
